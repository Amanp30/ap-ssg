...
class ApSSG {
   ...
   * @param {string[]} [options.insertHead] - (Optional) Array of HTML strings to insert inside <head>
   * @param {string[]} [options.insertBodyEnd] - (Optional) Array of HTML strings to insert before </body>
