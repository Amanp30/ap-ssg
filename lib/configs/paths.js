...
/**
 * Returns the absolute path to the custom 404 error page inside the build directory.
 *
 * @returns {string} Absolute path to the 404.html file.
 */
function getErrorPagePath() {
  return path.join(getBuildDirPath(), "404.html");
}
...
/**
 * Returns the absolute path to the `404.html` file located in `/src/assets/`.
 * This file is typically used as the custom 404 error page for the site.
 *
 * @returns {string} The absolute path to `src/assets/404.html`.
 */
function getSrcAssets404Path() {
  return path.join(ROOT, "src", "assets", "404.html");
}
